...
export default class EditFormView extends AbstractStatefulView {
  ...
  #handleTypeChange = (evt) => {
    ...
    if (newType === this._state.point.type) {
      return;
    }
  ...
  #initDatepickers() {
    ...
    this.#datepickerStart = flatpickr(startInput, {
      ...
      onChange: ([date]) => {
        if (date) {
          this.updateElement({ point: { ...this._state.point, startDateTime: date.toISOString() } });
        }
      }
    });
    ...
    this.#datepickerEnd = flatpickr(endInput, {
      ...
      onChange: ([date]) => {
        if (date) {
          this.updateElement({ point: { ...this._state.point, endDateTime: date.toISOString() } });
        }
      }
    });
  }
